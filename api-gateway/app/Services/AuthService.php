...
class AuthService
{
     ...
     * @return mixed
     */
    public function getRpcUserLogin(string $phone): mixed
    {
     ...
     * @return mixed
     */
    public function getRpcUserLogout(string $token): mixed
    {
     ...
     * @return mixed
     */
    public function getRpcUserCheckToken(string $token): mixed
    {
        Log::get()->info("调用getRpcUserLogout");
