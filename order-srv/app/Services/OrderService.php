...
class OrderService
{
     ...
     * @return array
     */
    public function orderList($userId): array
    {
     ...
     * @return bool|string
     */
    public function sageCreateOrder($data): bool|string
    {
     ...
     * @return true
     */
    public function sageCreateOrderCompensate($data): bool
    {
     ...
     * 投递订单消息到RabbitMQ
     */
    public function orderRabbitMQ(): void
    {
