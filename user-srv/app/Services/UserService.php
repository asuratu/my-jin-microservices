...
class UserService
{
     ...
     * @return array
     */
    public function userBonusList($page, $pageSize): array
    {
     ...
     * @return array
     */
    public function userStoredList($page, $pageSize): array
    {
        Log::get()->info("调用userBonusList");
     ...
     * @param $orderNo
     */
    public function changeStored($userId, $amount, $orderNo): void
    {
     ...
     * @param $orderNo
     */
    public function changeStoredCompensate($userId, $amount, $orderNo): void
    {
     ...
     * 投递用户消息到RabbitMQ
     */
    public function userRabbitMQ(): void
    {
